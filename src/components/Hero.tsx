  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-black via-secondary-gray to-primary-black text-white overflow-hidden">
      ...
      <div className="relative container-max">
        {/* Significantly increased padding top for mobile and desktop */}
        <div className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 md:pt-44 lg:pt-56">
          <div className="min-h-[70vh] md:min-h-[75vh] lg:min-h-[80vh] flex items-center">
